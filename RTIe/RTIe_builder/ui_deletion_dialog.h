...
public:
    ...
    void setupUi(QDialog *deletion_Dialog)
    {
        if (deletion_Dialog->objectName().isEmpty())
            deletion_Dialog->setObjectName(QStringLiteral("deletion_Dialog"));
        ...
        text_Remaining->setObjectName(QStringLiteral("text_Remaining"));
        ...
        remaining_Images_List->setObjectName(QStringLiteral("remaining_Images_List"));
        ...
        active_Area->setObjectName(QStringLiteral("active_Area"));
        ...
        text_Reason->setObjectName(QStringLiteral("text_Reason"));
        ...
        removal_Reason->setObjectName(QStringLiteral("removal_Reason"));
        ...
        image_File_Name->setObjectName(QStringLiteral("image_File_Name"));
        ...
        previous_Image_Button->setObjectName(QStringLiteral("previous_Image_Button"));

        horizontalLayout->addWidget(previous_Image_Button);

        next_Image_Button = new QPushButton(horizontalWidget);
        next_Image_Button->setObjectName(QStringLiteral("next_Image_Button"));
    ...
    {
        deletion_Dialog->setWindowTitle(QApplication::translate("deletion_Dialog", "Dialog", Q_NULLPTR));
        text_Remaining->setText(QApplication::translate("deletion_Dialog", "Remaining images:", Q_NULLPTR));
        text_Reason->setText(QApplication::translate("deletion_Dialog", "Reason for removal:", Q_NULLPTR));
        apply_All->setText(QApplication::translate("deletion_Dialog", "Apply to all", Q_NULLPTR));
        delete_Button->setText(QApplication::translate("deletion_Dialog", "Delete", Q_NULLPTR));
        image_File_Name->setText(QString());
        previous_Image_Button->setText(QApplication::translate("deletion_Dialog", "Previous", Q_NULLPTR));
        next_Image_Button->setText(QApplication::translate("deletion_Dialog", "Next", Q_NULLPTR));
    } // retranslateUi
