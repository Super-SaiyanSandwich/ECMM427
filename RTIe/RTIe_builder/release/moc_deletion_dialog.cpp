...
void deletion_Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        deletion_Dialog *_t = static_cast<deletion_Dialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject deletion_Dialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_deletion_Dialog.data,
      qt_meta_data_deletion_Dialog,  qt_static_metacall, nullptr, nullptr}
};
