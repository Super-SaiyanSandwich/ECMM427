...
public:
    ...
    void retranslateUi(QMainWindow *system_Ui)
    {
        ...
        export_2->setText(QApplication::translate("system_Ui", "Export", Q_NULLPTR));
        label_3->setText(QApplication::translate("system_Ui", "PAGE 2", Q_NULLPTR));
        btn1->setText(QApplication::translate("system_Ui", "< Prev", Q_NULLPTR));
        btn3->setText(QApplication::translate("system_Ui", "Next >", Q_NULLPTR));
        label_4->setText(QApplication::translate("system_Ui", "PAGE 3", Q_NULLPTR));
        btn2_2->setText(QApplication::translate("system_Ui", "< Prev", Q_NULLPTR));
        btn4->setText(QApplication::translate("system_Ui", "Next >", Q_NULLPTR));
        label_5->setText(QApplication::translate("system_Ui", "PAGE 4", Q_NULLPTR));
        btn3_2->setText(QApplication::translate("system_Ui", "< Prev", Q_NULLPTR));
        btn5_2->setText(QApplication::translate("system_Ui", "Next >", Q_NULLPTR));
