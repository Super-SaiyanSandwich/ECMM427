...
void image_Gatherer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        image_Gatherer *_t = static_cast<image_Gatherer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (image_Gatherer::*_t)();
        ...
        {
            typedef void (image_Gatherer::*_t)(const QImage & , const QString & );
...
const QMetaObject image_Gatherer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_image_Gatherer.data,
      qt_meta_data_image_Gatherer,  qt_static_metacall, nullptr, nullptr}
};
